...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="home.php?page=anggota">Data Petugas</a></div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-user-edit fa-2x"> Ubah Petugas</i>
                    <div class="card-body">
                        <div class="card">
                            <form method="POST">
                                <div class=" card-header">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="id_anggota" placeholder="PP001" value="<?= $tampil['id_anggota']; ?>" readonly>
                                    </div>
