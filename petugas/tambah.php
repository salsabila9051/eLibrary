<?php
$carikode = mysqli_query($koneksi, "SELECT id_petugas from tbl_petugas") or die(mysqli_error());
// menjadikannya array
...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="home.php?page=petugas">Dashboard</a></div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <i class="fa fa-user-plus fa-2x"> Tambah Petugas</i>
                    <div class="card-body">
                        <div class="card">
                            <form method="POST">
                                <div class=" card-header">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="id" placeholder="ID Petugas" autofocus required="true">
                                    </div>
...
if ($simpan) {
    $sql = $koneksi->query("INSERT INTO tbl_petugas (id_petugas, nama, alamat, no_telp, tgl_lahir)
